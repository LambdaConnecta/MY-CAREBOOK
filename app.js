...
function loadMyTasks() {
    ...
    pageContent.innerHTML = `
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
            <div>
                <h1 style="font-size: 32px; font-weight: 700; margin-bottom: 8px;">My Tasks</h1>
...
function loadStaff() {
    ...
    pageContent.innerHTML = `
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
            <div>
                <h1 style="font-size: 32px; font-weight: 700; margin-bottom: 8px;">Staff</h1>
...
function loadServiceUsers() {
    ...
    pageContent.innerHTML = `
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
            <div>
                <h1 style="font-size: 32px; font-weight: 700; margin-bottom: 8px;">Service Users</h1>
...
function loadRota() {
    document.getElementById('pageContent').innerHTML = `
        <h1 style="font-size: 32px; font-weight: 700; margin-bottom: 24px;">Rota</h1>
...
function loadVisits() {
    document.getElementById('pageContent').innerHTML = `
        <h1 style="font-size: 32px; font-weight: 700; margin-bottom: 24px;">Visits</h1>
        <div style="background: white; border-radius: 16px; padding: 40px; text-align: center;">
            <div style="font-size: 48px; margin-bottom: 16px;">🏠</div>
...
function loadMedications() {
    document.getElementById('pageContent').innerHTML = `
        <h1 style="font-size: 32px; font-weight: 700; margin-bottom: 24px;">Medications</h1>
        <div style="background: white; border-radius: 16px; padding: 40px; text-align: center;">
            <div style="font-size: 48px; margin-bottom: 16px;">💊</div>
...
function loadMARChart() {
    document.getElementById('pageContent').innerHTML = `
        <h1 style="font-size: 32px; font-weight: 700; margin-bottom: 24px;">MAR Chart</h1>
        <div style="background: white; border-radius: 16px; padding: 40px; text-align: center;">
            <div style="font-size: 48px; margin-bottom: 16px;">📋</div>
...
function loadCarePlans() {
    document.getElementById('pageContent').innerHTML = `
        <h1 style="font-size: 32px; font-weight: 700; margin-bottom: 24px;">Care Plans</h1>
        <div style="background: white; border-radius: 16px; padding: 40px; text-align: center;">
            <div style="font-size: 48px; margin-bottom: 16px;">📄</div>
...
function loadDailyLogs() {
    document.getElementById('pageContent').innerHTML = `
        <h1 style="font-size: 32px; font-weight: 700; margin-bottom: 24px;">Daily Care Logs</h1>
        <div style="background: white; border-radius: 16px; padding: 40px; text-align: center;">
            <div style="font-size: 48px; margin-bottom: 16px;">📝</div>
...
function loadReports() {
    document.getElementById('pageContent').innerHTML = `
        <h1 style="font-size: 32px; font-weight: 700; margin-bottom: 24px;">Reports</h1>
        <div style="background: white; border-radius: 16px; padding: 40px; text-align: center;">
            <div style="font-size: 48px; margin-bottom: 16px;">📈</div>
...
function loadAuditLog() {
    document.getElementById('pageContent').innerHTML = `
        <h1 style="font-size: 32px; font-weight: 700; margin-bottom: 24px;">Audit Log</h1>
        <div style="background: white; border-radius: 16px; padding: 40px; text-align: center;">
            <div style="font-size: 48px; margin-bottom: 16px;">👁</div>
